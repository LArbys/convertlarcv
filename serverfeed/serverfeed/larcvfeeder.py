...
class LArCVFeeder( BasePushWorker ):
    """ This class is meant to be a generic reader for LArCV files, both version 1 and 2 """

    def __init__( self,configfile,fillername,identity,pullsocket_address,user_batchprepfunction=None,port=0,batchsize=None):
        ...
        self.num_reads = 0
        self.user_batchprepfunction = user_batchprepfunction
